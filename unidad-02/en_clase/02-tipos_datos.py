...
print(3) # es un tipo de dato numerico y es int
print("El tipo de dato de 3 es: ", type(3)) # <class 'int'>

# Tipo de dato flotante
print(3.14) # es un tipo de dato numerico y es float
print("El tipo de dato de 3.14 es: ", type(3.14)) # <class 'float'>

# Tipo de dato string
print("Hola mundo") # es un tipo de dato string y es str
print("El tipo de dato de 'Hola mundo' es: ", type("Hola mundo")) # <class 'str'>
